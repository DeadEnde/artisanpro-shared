...
export const MODULES = {
  PEINTURE: { slug: 'peinture', nameFr: 'Peinture', nameEn: 'Painting', nameAr: 'الصباغة', price: 99 },
  CARRELAGE: { slug: 'carrelage', nameFr: 'Carrelage', nameEn: 'Tiling', nameAr: 'التبليط', price: 119 },
} as const;
